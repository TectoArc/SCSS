...
#stratified random sampling is d one on the datasets individually, followed by merging them into train and test data.
...
# The prediction output are stored in "predict" folder
...
def model_train(Data_Train_X,Data_Train_Y,Data_Test_X,Data_Test_Y,Regress_Mode, data_apply_1, data_apply_2, data_apply_3, data_apply_4, data_apply_5, data_apply_6, data_apply_7, data_apply_8, data_apply_9, data_apply_10, data_apply_11, data_apply_12, data_apply_13, data_apply_14, data_apply_15, data_apply_16, data_apply_17):
    ...
    np.savetxt('./predict/pred_1.txt',pred_1)
    np.savetxt('./predict/pred_2.txt',pred_2)
    np.savetxt('./predict/pred_3.txt',pred_3)
    np.savetxt('./predict/pred_4.txt',pred_4)
    np.savetxt('./predict/pred_5.txt',pred_5)
    np.savetxt('./predict/pred_6.txt',pred_6)
    np.savetxt('./predict/pred_7.txt',pred_7)
    np.savetxt('./predict/pred_8.txt',pred_8)
    np.savetxt('./predict/pred_9.txt',pred_9)
    np.savetxt('./predict/pred_10.txt',pred_10)
    np.savetxt('./predict/pred_11.txt',pred_11)
    np.savetxt('./predict/pred_12.txt',pred_12)
    np.savetxt('./predict/pred_13.txt',pred_13)
    np.savetxt('./predict/pred_14.txt',pred_14)
    np.savetxt('./predict/pred_15.txt',pred_15)
    np.savetxt('./predict/pred_16.txt',pred_16)
    np.savetxt('./predict/pred_17.txt',pred_17)
    ...
    if Regress_Mode == 0:
        ...
        feature_importance = ({'Features': ['Pressure', 'T', 'SiO2', 'TiO2', 'Al2O3', 'FeO', 'MgO', 'CaO', 'NiO', 'Na2O', 'K2O', 'H2O', 'Fe', 'Ni+Cu+Co', 'S', 'O'], 'Feature imp' : [model.feature_importances_]})
...
data_apply_1 = np.loadtxt('./to predict_dataset/Mars3GPa.txt')
data_apply_2 = np.loadtxt('./to predict_dataset/Pred_Earth_Bulk_HT.txt')
data_apply_3 = np.loadtxt('./to predict_dataset/Pred_Earth_Komatiite_IT.txt')
data_apply_4 = np.loadtxt('./to predict_dataset/Pred_Earth_MORB_LT.txt')
data_apply_5 = np.loadtxt('./to predict_dataset/Pred_Mars_basalt_Dry_HT.txt')
data_apply_6 = np.loadtxt('./to predict_dataset/Pred_Mars_basalt_Dry_IT.txt')
data_apply_7 = np.loadtxt('./to predict_dataset/Pred_Mars_basalt_Dry_LT.txt')
data_apply_8 = np.loadtxt('./to predict_dataset/Pred_Mars_basalt_Wet_HT.txt')
data_apply_9 = np.loadtxt('./to predict_dataset/Pred_Mars_basalt_Wet_IT.txt')
data_apply_10 = np.loadtxt('./to predict_dataset/Pred_Mars_basalt_Wet_LT.txt')
data_apply_11 = np.loadtxt('./to predict_dataset/Pred_Moon_Longhi_HT.txt')
data_apply_12 = np.loadtxt('./to predict_dataset/Pred_Moon_Longhi_IT.txt')
data_apply_13 = np.loadtxt('./to predict_dataset/Pred_Moon_Longhi_LT.txt')
data_apply_14 = np.loadtxt('./to predict_dataset/Pred_Moon_Taylor_HT.txt')
data_apply_15 = np.loadtxt('./to predict_dataset/Pred_Moon_Taylor_IT.txt')
data_apply_16 = np.loadtxt('./to predict_dataset/Pred_Moon_Taylor_LT.txt')
data_apply_17 = np.loadtxt('./to predict_dataset/Steenstra.txt')
